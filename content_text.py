...
- موبائل فون کا موضوع — اسکرین، نوٹیفکیشن، اسکرول، "فون دور رکھو"۔
  اس پر بہت کچھ آ چکا ہے۔ اگر موضوع فون کے گرد ہو تو اُس کا وہ حصہ لکھو
  جو فون کے بارے میں نہیں — نیند، کھانا، سامنے بیٹھا ہوا شخص۔
